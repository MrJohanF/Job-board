...
$enviar = "SELECT * FROM postulaciones INNER JOIN candidato ON postulaciones.Candidato_idCandidato = candidato.idCandidato INNER JOIN ciudad ON candidato.ciudad = ciudad.idCiudad WHERE Oferta_idOferta = $id_oferta AND estado_postulacion = '5'";
