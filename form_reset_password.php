            ...
            <div class="u-margin-top-4">
                <div class="col-1-of-3">
                    <div class="header-browser__line-vertical">
                        <h1 class="header-browser__title">Reset password</h1>
                        <h2 class="header-browser__subtitle">Reset password</h2>
                    </div>
                </div>
                <div class="col-2-of-3">
    ...
    <main>
        ...
        ?>
            ...
            ?>
                <section style="padding-top: 5rem;">
                    <div class="row">
                        <span style="color: black;" class="footer-subtitle-skills">El link es invalido o este enlance ya expiro.</span>
                    </div>
                </section>
